		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="carousel-item active">
				<video autoplay muted loop class="vdesk">
					<source src="<?php echo SITEPATH; ?>assets/img/slide/4.webm" type="video/webm">
				</video>
				...
				<div class="carousel-container">
					<div class="container">
						<h2 class="center animate__animated animate__fadeInDown">NETUNO</h2>
						<br>
						<hr class="bar"><br>
		...
		<div class="container" data-aos="zoom-in">
			...
			<div class="section-title">
				...
				<p class="center">Não é fácil ter visibilidade completa dos processos da área comercial de uma<br>
					empresa de saneamento. Com o Netuno você realiza uma gestão segura e<br>
			...
			<div class="row">
				<div class="col-lg-6 col1">
					<div class="section-title">
						...
						<hr class="bar"><br>
						<p class="justify">O Netuno automatiza a gestão da concessionária de forma intuitiva, por meio de sua estrutura inteligente e dinâmica possibilitando gerir clientes, consumos, cobrança, fiscalização, arrecadação, serviços, atendimento ao cliente, indicadores, contabilidade e jurídico.</p>
					</div>
				</div>
