			...
			<div class="row">
				<div class="col-lg-6 col1">
					<div class="section-title">
						...
						<hr class="bar"><br>
						<p>O Netuno automatiza a gestão da concessionária de forma intuitiva, por meio de sua estrutura inteligente e dinâmica possibilitando gerir clientes, consumos, cobrança, fiscalização, arrecadação, serviços, atendimento ao cliente, indicadores, contabilidade e jurídico.</p>
					</div>
				</div>
